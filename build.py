  ...
  <section class="section section-bg">
    <div class="container">
      <div class="section-header">
        ...
        <p>Browse models in this product line — FOB pricing for export orders, MOQ 30 pieces</p>
      </div>
...
def generate_detail_page(product, all_products):
    ...
    # Thumbnails: main is already shown above; avoid duplicating main in the strip
    detail_imgs = product.get('detailImages') or []
    extras = [img for img in detail_imgs if img != product.get('mainImage')]
    thumbnail_images = extras[:6]
    thumbnails_html = ''.join([f'''
            <div class="product-thumbnail" data-full-image="../{img}">
              <img src="../{img}" alt="{product['title']} detail">
            </div>''' for img in thumbnail_images])
    
    # Material-specific feature lists
    pid = product['id']
    if pid == 'glass-gaoshan':
        feat_items = [
            'Borosilicate glass - heat resistant up to 600°C',
            'Lightweight and elegant crystal-clear design',
            'Panda motif - playful and collectible',
            'Pairs perfectly with GIFT titanium drinkware',
            'FDA & LFGB compliant — tested by CNAS accredited laboratory',
            'Premium gift packaging included',
            f'Custom logo options available (Standard MOQ: 30pcs | Full custom OEM: 200pcs)'
        ]
    elif pid == 'office-rongyu':
        feat_items = [
            '304 stainless steel - durable and corrosion-resistant',
            'Double-wall vacuum insulation for temperature retention',
            'Lightweight and practical for daily office use',
            'Elegant design with tea-water separation',
            'FDA & LFGB compliant — tested by CNAS accredited laboratory',
            'Premium gift packaging included',
            f'Custom logo and color options available (Standard MOQ: 30pcs | Full custom OEM: 200pcs)'
        ]
    else:
        feat_items = [
...
<html lang="en">
<head><script>if(location.protocol==="http:"){{location.replace("https:"+window.location.href.substring(window.location.protocol.length))}}</script>
  <meta charset="UTF-8">
  <meta name="google" content="notranslate">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  
  <title>{product['title']} | GIFT Titanium Wholesale</title>
  <meta name="description" content="{truncate_meta(product['description'])} FOB {product['priceDisplay']}. MOQ 30pcs.">
  ...
  {{
    ...
    "image": "https://cixiangift.com/{product['mainImage']}",
    "offers": {{
      "@type": "Offer",
      ...
      "url": "https://cixiangift.com/products/{product['slug']}"
    }}
  }}
  </script>
</head>
      ...
      <div class="product-detail-grid">
        ...
        <div class="product-info">
          ...
          <div class="product-price-section">
            ...
            <span class="product-moq">MOQ: <strong>30 pieces</strong> | Volume discounts available</span>
          </div>
          ...
          <div class="product-rich-content">
            <div class="rich-section">
              ...
              <p>As a B2B buyer or brand manager, you need products that stand out in your market. The {product['title']} combines premium materials with practical design, making it an ideal choice for corporate gifting, retail distribution, and private label programs.</p>
              <ul>
                <li><strong>Competitive wholesale pricing</strong> — starting from ${product['priceMin']} FOB, with volume discounts for larger orders</li>
                <li><strong>Low MOQ</strong> — start with just 30 pieces for standard products, 200 pieces for full custom OEM</li>
                <li><strong>Fast sample delivery</strong> — samples available within 5-7 business days</li>
                <li><strong>Quality assured</strong> — FDA & LFGB compliant, tested by CNAS-accredited laboratory</li>
              </ul>
            </div>
            ...
            <div class="rich-section">
              <h3>Perfect For</h3>
              <ul>
                <li><strong>Corporate gifting programs</strong> — premium titanium drinkware makes a lasting impression on clients and employees</li>
                <li><strong>Retail & e-commerce</strong> — high-margin product category with growing consumer demand for titanium</li>
                <li><strong>Private label & OEM</strong> — customize colors, engraving, and packaging to build your own brand</li>
                <li><strong>Promotional merchandise</strong> — stand out from generic steel and plastic drinkware</li>
              </ul>
            </div>

            <div class="rich-section">
              <h3>Customization Options</h3>
              <p>Make this product uniquely yours:</p>
              <ul>
                <li><strong>Color anodization</strong> — available in multiple finishes (MOQ 200pcs for custom colors)</li>
                <li><strong>Laser engraving</strong> — add your logo, brand name, or custom design</li>
                <li><strong>Custom packaging</strong> — branded gift boxes, retail-ready packaging</li>
                <li><strong>Private labeling</strong> — your brand on the product and all materials</li>
              </ul>
            </div>
            ...
            <div class="rich-section">
              ...
              <ol>
                <li><strong>Request a quote</strong> — tell us your quantity, customization needs, and destination</li>
                <li><strong>Sample approval</strong> — we send samples for quality confirmation (5-7 days)</li>
                <li><strong>Production</strong> — standard production runs 15-25 days depending on order size</li>
                <li><strong>Quality inspection</strong> — all orders undergo QC before shipping</li>
                <li><strong>Shipping</strong> — FOB Ningbo/Shanghai, or door-to-door delivery available</li>
              </ol>
            </div>
          </div>
...
{sub_products_section}
  ...
  <section class="cta-section" id="quote">
    <div class="container">
      ...
      <p>Get our wholesale catalog with FOB pricing for bulk orders. MOQ starts at 30 pieces.</p>
  ...
  <footer class="footer">
    <div class="container">
      ...
      <div class="footer-bottom"><p class="footer-copyright">© 2026 Cixian Intelligent Technology (Jiaxing) Co., Ltd. All rights reserved.</p></div>
    </div>
  </footer>
